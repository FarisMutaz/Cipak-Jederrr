          ...
          {isModalOpen && (
            <div className="fixed inset-0 bg-black/40 backdrop-blur-xs z-[100] flex justify-end">
              ...
              <motion.div
                ...
                className="bg-white w-full max-w-md h-full border-l border-border-custom shadow-2xl relative flex flex-col p-6 z-10"
              >
                <div className="flex justify-between items-center mb-5 pb-3 border-b border-border-custom">
                  ...
                  <button
                    ...
                    className="text-gray-400 hover:text-text-custom transition-colors cursor-pointer"
                  >
                    <X className="w-5 h-5" />
                  </button>
                </div>
                ...
                <form onSubmit={handleSubmit(onFormSubmit)} className="flex flex-col flex-1 overflow-hidden">
                  <div className="flex-1 overflow-y-auto pr-1 py-1 flex flex-col gap-4">
                    {/* Name */}
                    ...
                    <div className="flex flex-col gap-1.5">
                      ...
                      <select
                        {...register("roleName")}
                        className="px-3.5 py-2.5 bg-bg-custom border border-border-custom rounded-xl text-xs focus:outline-none focus:border-primary/50 text-text-custom font-bold cursor-pointer"
                      >
                    ...
                    {(selectedRole === "KASIR" || selectedRole === "KOORLAP") && (
                      <div className="flex flex-col gap-2">
                        ...
                        <div className="border border-border-custom rounded-xl p-3 bg-bg-custom flex flex-col gap-2 max-h-[200px] overflow-y-auto">
                          {allOutlets.length === 0 ? (
                  ...
                  {/* Actions */}
                  <div className="flex items-center gap-3 pt-4 border-t border-border-custom bg-white mt-auto">
                    <button
                      type="button"
                      onClick={() => setIsModalOpen(false)}
