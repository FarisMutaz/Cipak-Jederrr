...
export async function DELETE(req: Request) {
  ...
  try {
    ...
    return NextResponse.json({ message: ids.length > 1 ? "Riwayat mutasi terpilih berhasil dihapus & stok telah disesuaikan!" : "Riwayat mutasi berhasil dihapus & stok telah disesuaikan!" });
  } catch (error: any) {
    return NextResponse.json(
