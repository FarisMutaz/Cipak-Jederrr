...
const MENU_ITEMS: MenuItem[] = [
  ...
  { title: "Stok Produk", href: "/stok", icon: Boxes, roles: ["DEVELOPER", "OWNER", "KOORLAP"] },
  { title: "Input Stok", href: "/input-stok", icon: FileSpreadsheet, roles: ["DEVELOPER", "OWNER", "KOORLAP"] },
  { title: "Stok Opname", href: "/stok-opname", icon: ClipboardList, roles: ["DEVELOPER", "OWNER", "KOORLAP"] },
