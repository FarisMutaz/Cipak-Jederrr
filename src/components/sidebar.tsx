...
const MENU_ITEMS: MenuItem[] = [
  ...
  { title: "Distribusi & Input Stok", href: "/distribusi-stok", icon: FileSpreadsheet, roles: ["DEVELOPER", "OWNER", "KOORLAP"] },
  ...
  { title: "Audit Logs", href: "/audit-logs", icon: ClipboardList, roles: ["DEVELOPER", "OWNER"] },
